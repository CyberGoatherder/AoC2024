    ...
    for page in book:
        ...
        if book.index(current_page) + 1 < len(book):
            ...
            if next_page not in valid_next_pages:
                print(f"\033[91m    [!] Invalid next page: {next_page}\033[0m")
                is_valid = False
                break
        ...
        if book.index(current_page) > 0:
            ...
            if prev_page not in valid_previous_pages:
                print(f"\033[91m    [!] Invalid previous page: {prev_page}\033[0m")
                is_valid = False
                break
    # If the flag has remained "True" we know the book is valid, append it to the valid books list
    if is_valid:
        print(f"\033[92m    [+] Complete book is valid\033[0m")
...
for book in valid_books:
    ...
    print(f"[+] Valid Book: {book} | \033[97mMiddle page: {middle_page}\033[0m")
